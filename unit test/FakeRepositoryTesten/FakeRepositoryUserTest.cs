...
namespace unit_test.FakeRepositories
{
    public class FakeUserRepository : IUserRepository
    {
        ...
        {
            new UserDTO(1, BCrypt.Net.BCrypt.HashPassword("wachtwoord123"), "test@student.fontys.nl"),
            new UserDTO(2, BCrypt.Net.BCrypt.HashPassword("admin456"), "admin@student.fontys.nl")
        };
        ...
        public void AddUser(string email, string wachtwoord)
        {
            ...
            _users.Add(new UserDTO(newId, hashedWachtwoord, email));
        }
        public void UpdateWachtwoord(int gebruikerId, string nieuwWachtwoord)
        {
            ...
            _users.Remove(user);
            _users.Add(new UserDTO(user.Id, hashedWachtwoord, user.Email));
        }
